...
urlpatterns = [
    ...
    path('empleado/detalle/panel/ajax/', views.EmpleadoDetailPanelAjax, name='empl_detail_info_ajax'),
    ...
    path('empleado/<int:empl_id>/vacaciones/eliminar/<int:pk>/', views.VacacionesDeleteView.as_view(), name='empl_vaca_delete'),
